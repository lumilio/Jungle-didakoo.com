import MonkeyIcon from '../../images/board/animals/icon-36.png';
import LionIcon from '../../images/board/animals/icon-39.png';
import CatIcon from '../../images/board/animals/icon-59.png';
...
const NFT_LINKS = {
    ...
    nft_22_leo_1: LionIcon,
    nft_23_leo_2: LionIcon,
    nft_24_leo_3: LionIcon,
    nft_25_wb: WBIcon,
}
export default NFT_LINKS;
