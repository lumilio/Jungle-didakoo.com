...
export default function colorIconNft(colorIcon){
    return {
        ...
        nft_8_bot: '',
        nft_21_raygun: '',
        nft_9_cat: colorIcon === '#3C5FA1' ? CatIconWhite : CatIconBlack,
        nft_10_monkey: colorIcon === '#3C5FA1' ? MonkeyIconWhite : MonkeyIconBlack,
        nft_11_punks: '',
        nft_12_monster: '',
        nft_13_doodle: '',
        ...
        nft_22_leo_1: colorIcon === '#3C5FA1' ? LionIconWhite : LionIconBlack,
        nft_23_leo_2: colorIcon === '#3C5FA1' ? LionIconWhite : LionIconBlack,
        nft_24_leo_3: colorIcon === '#3C5FA1' ? LionIconWhite : LionIconBlack,
        nft_25_wb: WBIcon,
    };
}
